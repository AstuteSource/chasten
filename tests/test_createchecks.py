from chasten.createchecks import is_valid_api_key, generate_yaml_config  # fmt: skip
...
def test_generate_yaml_config():
    global valid_api_key, test_genscript, file_path  # fmt: skip
